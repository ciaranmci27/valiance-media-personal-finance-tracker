...
const nextConfig: NextConfig = {
  ...
  // The Postgres driver only serves the local fixture database; keep it out
  // of server bundles so its optional runtime modules are never evaluated.
  serverExternalPackages: ["pg"],
  // Keep repository guidance under source control rather than generated by dev startup.
  agentRules: false,
