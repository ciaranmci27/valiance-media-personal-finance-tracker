...
> = {
  // Keep in step with accounting.contractor_report, which accepts 2022 through 2026.
  2022: {
    minimum_cents: "60000",
    source: "https://www.irs.gov/pub/irs-prior/i1099mec--2022.pdf",
    revision: "2022-01",
  },
  2023: {
    minimum_cents: "60000",
    source: "https://www.irs.gov/pub/irs-prior/i1099mec--2023.pdf",
    revision: "2023-01",
  },
  2024: {
    minimum_cents: "60000",
    source: "https://www.irs.gov/pub/irs-prior/i1099mec--2024.pdf",
    revision: "2024-01",
  },
  2025: {
    minimum_cents: "60000",
...
export const contractorFilterSchema = z
  .object({
