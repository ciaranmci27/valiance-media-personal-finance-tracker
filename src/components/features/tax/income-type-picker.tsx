...
function getOptions(): IncomeTypeOption[] {
  return [
    ...
    {
      value: "qualified_dividend",
      label: "Qualified Dividends",
      description: "1099-DIV box 1b",
      taxNote: "Taxed at capital gain rates",
    },
    {
      value: "retirement",
      label: "Retirement",
      description: "IRA & 401(k) distributions",
      taxNote: "Ordinary rates, exempt from NIIT",
    },
  ];
}
